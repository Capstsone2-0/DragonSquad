...
import './Deposit.css';
import depositPerson from '../../Assets/images/Cool Kids Bust.png'
...
const Deposit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:8080/addDeposit', {
        method: 'POST',
        headers: {
      ...
      <div className='contents'>
        <div className='Form'>
          <div className='picture'>
            ...
            <img className='AvatarPic' src={depositPerson} alt='avatar'></img>
            Deposit
          </div>
